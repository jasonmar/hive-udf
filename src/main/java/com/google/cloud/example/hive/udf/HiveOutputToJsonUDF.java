 ...
 *
 **/
package com.google.cloud.example.hive.udf;
...
@Description(name = "to_json", value = "_FUNC_(struct) - converts Hive struct to JSON string")
public class HiveOutputToJsonUDF extends GenericUDF {
    ...
    public ObjectInspector initialize(ObjectInspector[] args) throws UDFArgumentException {
        if (args.length != 1) {
            throw new UDFArgumentException("HiveOutputToJsonUDF takes an object as an argument");
        }
